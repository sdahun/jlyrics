...
public class CustomVersionInVersionsTest {
    private Song song;
    ...
    void setupSong() {
        ...
        this.song.getProperties().setCustomVersion("Christmas Version");
    }
    ...
    void testFormatInVersion(SongVersion songVersion) throws Exception {
        ...
        try (
                InputStream expectedXml = this.getClass().getClassLoader().getResourceAsStream("expected/customVersionIn" + songVersion.toString() + ".xml");
